Public Class frmSeccionesImpresion

    Private Sub frmSeccionesImpresion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGASIGGPO()
        ...
        Dim NUM As Integer
        NUM = 1
        Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGSECCIONIMPRESION()", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        ...
        End If
        ACTIVAR(False)
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE,ACTIVO FROM SECCIONIMPRESION WHERE CLAVE=" + TXTCLA.Text + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        SQLGUARDAR.CommandText = "SPSECCIONIMPRESION"
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If xyz = 6 Then
            Try
                ...
                SQLELIMINAR.CommandText = "DELETE FROM SECCIONIMPRESION WHERE CLAVE=" + TXTCLA.Text
    ...
    Private Sub BTNBUSCAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,ACTIVO FROM SECCIONIMPRESION", " WHERE NOMBRE", " ORDER BY NOMBRE", "Búsqueda de secciones de impresión", "Nombre de la sección de impresión", "Seccion(es) de impresión", 1, frmPrincipal.CadenaConexion, True)
